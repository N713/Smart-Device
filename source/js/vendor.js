...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = t || self).IMask = {});
}(void 0, function (t) {
  "use strict";
  ...
  var u = function u(t) {
    return t && t.Math == Math && t;
      ...
      i = u("object" == (typeof globalThis === "undefined" ? "undefined" : _typeof2(globalThis)) && globalThis) || u("object" == (typeof window === "undefined" ? "undefined" : _typeof2(window)) && window) || u("object" == (typeof self === "undefined" ? "undefined" : _typeof2(self)) && self) || u("object" == _typeof2(e) && e) || Function("return this")(),
      r = function r(t) {
    try {
      return !!t();
    } catch (t) {
    ...
    return e;
      ...
      T = i["__core-js_shared__"] || w("__core-js_shared__", {}),
      O = Function.toString;
  ...
  var $ = {
    ...
    if (n = l ? i : h ? i[o] || w(o, {}) : (i[o] || {}).prototype) for (u in e) {
      if (a = e[u], r = t.noTargetGet ? (s = Ct(n, u)) && s.value : n[u], !Et(l ? u : o + (h ? "." : "#") + u, t.forced) && void 0 !== r) {
        if (_typeof2(a) == _typeof2(r)) continue;
        kt(a, r);
      }
  ...
  var Ot = "".repeat || function (t) {
    ...
    start: xt(!1),
      ...
      Rt = /Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(It),
      jt = Pt.end;
  ...
  function Nt(t) {
    return (Nt = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
      return _typeof2(t);
    } : function (t) {
  ...
  function Kt(t, e) {
    return !e || "object" != _typeof2(e) && "function" != typeof e ? function (t) {
  ...
  Ft({
    ...
    "object" != (typeof globalThis === "undefined" ? "undefined" : _typeof2(globalThis)) && (this ? e() : (t.defineProperty(t.prototype, "_T_", {
      configurable: !0,
      get: e
    }), _T_));
  }(Object);
  ...
  var ue = function () {
    ...
    function t() {
      ...
      Lt(this, t), this.value = e, this.from = n, this.stop = u;
    }
  ...
  var se = function () {
    ...
    return Ut(t, [{
      ...
      value: function value() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
        return new re(this.extractInput(t, e), t);
      }
    }, {
      key: "appendTail",
      value: function value(t) {
      ...
      value: function value(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (t = this.doPrepare(t, e)) ? (this._value += t, new ie({
          inserted: t,
          rawInserted: t
        })) : new ie();
      }
      ...
      value: function value(t) {
        ...
        if (i.inserted) {
          ...
          a || (i = new ie(), this.state = u, n && r && (n.state = r));
        }
      ...
      value: function value() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
        return this._value = this.value.slice(0, t) + this.value.slice(e), new ie();
      }
    }, {
  ...
  function oe(t) {
    ...
    return t instanceof RegExp ? ae.MaskedRegExp : Qt(t) ? ae.MaskedPattern : t instanceof Date || t === Date ? ae.MaskedDate : t instanceof Number || "number" == typeof t || t === Number ? ae.MaskedNumber : Array.isArray(t) || t === Array ? ae.MaskedDynamic : ae.Masked && t.prototype instanceof ae.Masked ? t : t instanceof Function ? ae.MaskedFunction : (console.warn("Mask not found for mask", t), ae.Masked);
  }
  ...
  var he = {
    ...
    return Ut(t, [{
      ...
      value: function value() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
        return 0 === t && e >= 1 ? (this._isFilled = !1, this.masked.remove(t, e)) : new ie();
      }
    }, {
      key: "_appendChar",
      value: function value(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (this._isFilled) return new ie();
      ...
      key: "nearestInputPos",
      value: function value(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : te.NONE,
            n = 0,
            u = this.value.length,
    ...
    return Ut(t, [{
      ...
      value: function value() {
        ...
        return this._value = this._value.slice(0, t) + this._value.slice(e), this._value || (this._isRawInput = !1), new ie();
      }
    }, {
      key: "nearestInputPos",
      value: function value(t) {
    ...
    function t() {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
          n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
      Lt(this, t), this.chunks = e, this.from = n;
    }
    ...
    return Ut(t, [{
      ...
      value: function value(e) {
        if (String(e)) {
          Qt(e) && (e = new re(String(e)));
          var n = this.chunks[this.chunks.length - 1],
              u = n && (n.stop === e.stop || null == e.stop) && e.from === n.from + n.toString().length;
          if (e instanceof re) u ? n.extend(e.toString()) : this.chunks.push(e);else if (e instanceof t) {
      ...
      key: "appendTo",
      value: function value(e) {
        if (!(e instanceof ae.MaskedPattern)) return new re(this.toString()).appendTo(e);
      ...
      set: function set(e) {
        ...
        Object.assign(this, u), this.chunks = n.map(function (e) {
          var n = "chunks" in e ? new t() : new re();
          return n.state = e, n;
        });
      }
    }]), t;
    ...
    function e() {
      ...
      return Lt(this, e), t.definitions = Object.assign({}, he, t.definitions), Kt(this, zt(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)));
    }
    ...
    return Gt(e, t), Ut(e, [{
      ...
      value: function value() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
            u = Wt(zt(e.prototype), "remove", this).call(this, t, n);
      ...
      value: function value(t) {
        ...
        if (!r) return t;
        var a = u;
        0 !== a && a < r.value.length && (a = r.nearestInputPos(u, ee(e)));
        ...
        if (e === te.LEFT || e === te.FORCE_LEFT) {
          ...
          if (null != _) {
            var b = this._blocks[_],
                E = b.nearestInputPos(0, te.RIGHT);
            if (0 === E && b.unmaskedValue.length) return this._blockStartPos(_) + E;
          }

          for (var C, F = -1, S = l - 1; S >= 0; --S) {
            var D = this._blocks[S],
                B = D.nearestInputPos(D.value.length, te.FORCE_LEFT);

            if (D.value && 0 === B || (C = S), 0 !== B) {
          ...
          if (e === te.LEFT) for (var w = F + 1; w <= Math.min(l, this._blocks.length - 1); ++w) {
            var T = this._blocks[w],
                O = T.nearestInputPos(0, te.NONE),
                M = this._blockStartPos(w) + O;
            if (M > t) break;
            if (O !== T.value.length) return M;
          }
          if (F >= 0) return this._blockStartPos(F) + this._blocks[F].value.length;
          if (e === te.FORCE_LEFT || this.lazy && !this.extractInput() && !ve(this._blocks[l])) return 0;
          if (null != C) return this._blockStartPos(C);

          for (var x = l; x < this._blocks.length; ++x) {
            var P = this._blocks[x],
                I = P.nearestInputPos(0, te.NONE);
            if (!P.value.length || I !== P.value.length) return this._blockStartPos(x) + I;
          }
        ...
        if (e === te.RIGHT || e === te.FORCE_RIGHT) {
          ...
          if (null != R && null != j) {
            for (var H = R; H < this._blocks.length; ++H) {
              var U = this._blocks[H],
                  G = U.nearestInputPos(0, te.FORCE_RIGHT);
              if (G !== U.value.length) return this._blockStartPos(H) + G;
            }
          ...
          for (var z = Math.min(l, this._blocks.length - 1); z >= 0; --z) {
            var Y = this._blocks[z],
                Z = Y.nearestInputPos(Y.value.length, te.LEFT);

            if (0 !== Z) {
              var K = this._blockStartPos(z) + Z;
              if (K >= t) return K;
              break;
            }
          }
  ...
  function ve(t) {
    if (!t) return !1;
    var e = t.value;
    return !e || t.nearestInputPos(0, te.NONE) !== e.length;
  }

  de.DEFAULTS = {
    lazy: !0,
    placeholderChar: "_"
  }, de.STOP_CHAR = "`", de.ESCAPE_CHAR = "\\", de.InputDefinition = ce, de.FixedDefinition = fe, ae.MaskedPattern = de;
  ...
  var ge = function (t) {
    ...
    return Gt(e, t), Ut(e, [{
      ...
      value: function value() {
        ...
        return (t = Wt(zt(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i)) && (!this.isComplete || this.isDateExist(this.value) && null != n && (null == this.min || this.min <= n) && (null == this.max || n <= this.max));
      }
    }, {
      key: "isDateExist",
      value: function value(t) {
  ...
  var me = function (t) {
    function e(t) {
      var n;
      return Lt(this, e), (n = Kt(this, zt(e).call(this))).input = t, n._handlers = {}, n;
    }
  ...
  var Ae = function () {
    ...
    return Ut(t, [{
      ...
      value: function value() {
        ...
        var t = new ue(this.el.value, this.cursorPos, this.value, this._selection),
            e = this.masked.rawInputValue,
            n = this.masked.splice(t.startChangePos, t.removed.length, t.inserted, t.removeDirection).offset,
            u = e === this.masked.rawInputValue ? t.removeDirection : te.NONE,
      ...
      set: function set(t) {
        if (!this.maskEquals(t)) if (this.masked.constructor !== oe(t)) {
          var e = le({
            mask: t
          });
  ...
  var Ee = function (t) {
    ...
    return Gt(e, t), Ut(e, [{
      ...
      value: function value() {
        ...
        return t = r[0], n = r[1], this._removeThousandsSeparators(Wt(zt(e.prototype), "extractInput", this).call(this, t, n, u));
      }
    }, {
      key: "_appendCharRaw",
      value: function value(t) {
        ...
        var r = Wt(zt(e.prototype), "_appendCharRaw", this).call(this, t, n);
        ...
        switch (e) {
          ...
          case te.FORCE_LEFT:
            ...
            if (n >= 0) {
              ...
              if (t < u || this.value.length <= u || e === te.FORCE_LEFT) return n;
            }
  ...
  ae.MaskedFunction = Fe;

  var Se = function (t) {
    function e(t) {
      var n;
      return Lt(this, e), (n = Kt(this, zt(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))).currentMask = null, n;
    }
    ...
    return Gt(e, t), Ut(e, [{
      ...
      set: function set(t) {
        ...
        this.compiledMasks.forEach(function (t, e) {
          return t.state = n[e];
        }), null != u && (this.currentMask = u, this.currentMask.state = i), Xt(zt(e.prototype), "state", r, this, !0);
      }
    }, {
      key: "overwrite",
      get: function get() {
  ...
  function Be(t) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : De.MASKED,
        n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : De.MASKED,
        u = le(t);
    return function (t) {
